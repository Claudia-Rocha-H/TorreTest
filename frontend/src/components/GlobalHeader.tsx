  ...
  return (
    <header className="flex justify-between items-center px-8 py-4 bg-dark-bg border-b border-border">
      ...
      <div className="flex items-center">
        <Link href="/" className="flex items-center font-bold text-xl text-white-text">
      ...
      <nav>
        <ul className="flex items-center gap-6">
          <li>
            <button type="button" className="flex flex-col items-center text-sm text-light-text hover:text-white-text transition-colors duration-300">
